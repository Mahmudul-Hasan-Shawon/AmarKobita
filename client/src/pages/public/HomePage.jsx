          ...
          {randomWriting && (
            ...
            >
              <div className="p-8 bg-ink-900/40 border border-ink-800/30 rounded-sm">
                <p className={`${randomWriting.language === 'bangla' ? 'font-bangla' : 'font-display'} text-xl md:text-[1.35rem] leading-relaxed text-ink-100 whitespace-pre-line line-clamp-6`}>
                  {randomWriting.text}
                </p>
